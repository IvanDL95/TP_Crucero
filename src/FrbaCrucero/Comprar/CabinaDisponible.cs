...
namespace FrbaCrucero.Compra_Reservar
{
    public partial class CabinaDisponible : Form
    {
        ...
        public CabinaDisponible(Compra compra, Int32 idViaje, Int32 idCliente, Int32 tipoDoc, String idRecorrido, Int32 puertoDesde, Int32 puertoHasta, bool esCompra)
        {
            InitializeComponent();
